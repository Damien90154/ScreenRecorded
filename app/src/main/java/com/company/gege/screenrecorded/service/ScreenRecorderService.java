package com.company.gege.screenrecorded.service;
...
import com.company.gege.screenrecorded.media.MediaAudioEncoder; 
import com.company.gege.screenrecorded.media.MediaEncoder; 
import com.company.gege.screenrecorded.media.MediaMuxerWrapper; 
import com.company.gege.screenrecorded.media.MediaScreenEncoder; 
 
public class ScreenRecorderService extends IntentService { 
 private static final boolean DEBUG = false; 
 private static final String TAG = "ScreenRecorderService"; 
 
 private static final String BASE = "com.company.gege.screenrecorded.service.ScreenRecorderService.";
 ...
 private void updateStatus() { 
  ...
  Intent intent = result.putExtra(EXTRA_QUERY_RESULT_PAUSING, isPausing);
